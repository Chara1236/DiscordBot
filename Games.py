...
async def rainbow(ctx, level=None):
        ...
        br = ":brown_square:"
        gamemaps = [[[g,r,r,r,r,r,r,r],[g,g,g,g,g,g,r,r],[g,r,r,g,r,r,g,g],[g,r,r,g,r,r,r,g],[g,g,r,g,g,r,r,g],[r,r,r,r,g,g,g,g],[r,r,g,g,g,r,r,r],[r,r,g,g,g,g,g,g]]
                    ,[[g,y,g,g,g,p,g,o],[y,y,g,p,g,g,g,p],[p,p,p,p,p,p,p,p],[r,r,g,r,r,r,r,r],[g,r,br,r,g,g,g,y],[g,g,r,g,g,g,g,r],[w,r,r,r,r,r,r,r],[g,b,g,b,g,b,g,g]]]
        global deletemode
        if deletemode == False:
            ...
            locr = 0
            locc = 0
            colours = [":white_large_square:",":brown_square:", ":red_square:", ":orange_square:", ":yellow_square:", ":green_square:", ":blue_square:", ":purple_square:"]
            ...
            try:
                while choice != 'e':
                    ...
                    if mapinfo[locr][locc] == ":red_square:":
                        ...
                        locc = 0
                        flavour = "none"
                    elif mapinfo[locr][locc] == ":brown_square:" and flavour == ":tangerine:" and 0 < locc < 7 and 0 < locr < 7:
                        print('e')
